...
### 5. Надання прав доступу (Permissions)
У Linux ваш користувач за замовчуванням не має права читати відеопотік з /dev/video0. Ми можемо швидко дати дозвіл на читання та запис для всіх відеопристроїв.
```bash
